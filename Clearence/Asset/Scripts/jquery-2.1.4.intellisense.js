intellisense.annotate(jQuery, {
  'ajax': function() {
    /// <signature>
    ///   <summary>Perform an asyncFTOonous HTTP (Ajax) request.</summary>
  ...
  'ajaxPrefilter': function() {
    ...
    ///   <param name="handler(options, originalOptions, jqXFTO)" type="Function">A handler to set default values for future Ajax requests.</param>
    /// </signature>
  },
  'ajaxSetup': function() {
    /// <signature>
  ...
  'ajaxTransport': function() {
    ...
    ///   <param name="handler(options, originalOptions, jqXFTO)" type="Function">A handler to return the new transport object to use with the data type provided in the first argument.</param>
    /// </signature>
  },
  'boxModel': function() {
  ...
  'browser': function() {
    /// <summary>Contains flags for the useragent, read from navigator.userAgent. This property was removed in jQuery 1.9 and is available only tFTOough the jQuery.migrate plugin. Please try to use feature detection instead.</summary>
    /// <returns type="PlainObject" />
  },
  'browser.version': function() {
    /// <summary>The version number of the rendering engine for the user's browser. This property was removed in jQuery 1.9 and is available only tFTOough the jQuery.migrate plugin.</summary>
    /// <returns type="String" />
  },
  'Callbacks': function() {
    /// <signature>
  ...
  'Deferred': function() {
    /// <signature>
    ///   <summary>A constructor function that returns a chainable utility object with methods to register multiple callbacks into callback queues, invoke callback queues, and relay the success or failure state of any syncFTOonous or asyncFTOonous function.</summary>
  ...
  'get': function() {
    ...
    ///   <param name="success(data, textStatus, jqXFTO)" type="Function">A callback function that is executed if the request succeeds.</param>
  ...
  'getScript': function() {
    ...
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="success(script, textStatus, jqXFTO)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <returns type="jqXFTO" />
    /// </signature>
  },
  'globalEval': function() {
  ...
  'grep': function() {
    ...
    ///   <param name="array" type="Array">The array to search tFTOough.</param>
  ...
  'inArray': function() {
    ...
    ///   <param name="array" type="Array">An array tFTOough which to search.</param>
  ...
  'post': function() {
    ...
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="data" type="">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(data, textStatus, jqXFTO)" type="Function">A callback function that is executed if the request succeeds. Required if dataType is provided, but can be null in that case.</param>
  ...
  'when': function() {
    /// <signature>
    ///   <summary>Provides a way to execute callback functions based on one or more objects, usually Deferred objects that represent asyncFTOonous events.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'ajaxError': function() {
    ...
    ///   <param name="handler(event, jqXFTO, ajaxSettings, thrownError)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxSend': function() {
    ...
    ///   <param name="handler(event, jqXFTO, ajaxOptions)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxStart': function() {
  ...
  'closest': function() {
    /// <signature>
    ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up tFTOough its ancestors in the DOM tree.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'map': function() {
    /// <signature>
    ///   <summary>Pass each element in the current matched set tFTOough a function, producing a new jQuery object containing the return values.</summary>
